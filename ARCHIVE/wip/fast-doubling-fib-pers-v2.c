//My implementation knowing matrix exponenciation for Fibonacci to make one without matrix, at v2 using a pair and recursion
#include <stdio.h>
...
int main (){
	...
	int i;
	pair<llu, llu> fib, aux;
	pair<llu, llu> fib_arr[100]; //Fibs in powers of 2, to form the answer
	llu n;
	int mod;
