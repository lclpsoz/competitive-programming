//1055 with print to analyse pattern (if most of the numbers are larger than average, the answer will be based on larger in the middle, if answer will be the smallest in the middle if the majority of numbers are below average
#include <bits/stdc++.h>
using namespace std;
